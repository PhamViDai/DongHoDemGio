...
fun StopwatchScreen() {
    ...
    val hours = milliseconds / 3600000    // Tính giờ
    val minutes = (milliseconds % 3600000) / 60000   // Tính phút
    val seconds = (milliseconds % 60000) / 1000   // Tính giây
    val millis = milliseconds % 1000   // Tính mili giây
